...
public:
    ...
    [[eosio::action]] void setpartner( symbol_code sym_code, string action, name appeallant );

    [[eosio::action]] void applyaddr( name appeallant, symbol_code sym_code, name to );
...
private:
    ...
    using appeallants = eosio::multi_index< "appeallants"_n, appeallant_ts >;
